...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
							<h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">مرحباٌ بك {{ Auth::user()->name }} !</h2>
							<p class="mg-b-0">في لوحة التحكم الخاصة بك </p>
						</div>
					</div>
					<div class="main-dashboard-header-right">
						...
						<div>
							<label class="tx-13">المبيعات دون اتصال</label>
							<h5>783,675</h5>
						</div>
					</div>
				</div>
