						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
										<a class="modal-effect col-sm-6 col-md-3 mg-t-10 mg-sm-t-0" 
											data-effect="effect-scale"
											data-toggle="modal" 
											href="#modaldemo8">
											<button class="btn btn-primary btn-with-icon btn-block">
								...
								<div class="modal-body">
									<form action="{{ route('sections.store') }}" method="post">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="section_name" name="section_name" autocomplete="off">
										</div>
