								...
								<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
									<div class="card-sigin">
										...
										<div class="main-signup-header">
											...
											<h6 class="font-weight-normal mb-4">مجاناً و بسهوله .</h6>
											<form method="POST" action="{{ route('register') }}">
												...
												<button class="btn btn-main-primary btn-block">{{ __('إنشاء حساب') }}</button>

											</form>

											<div class="main-signup-footer mt-5">
												<p>تمتلك حساب بالفعل ؟ <a href="{{ url('/' . $page='login') }}">{{ __('تسجيل الدخول') }}</a></p>
											</div>
